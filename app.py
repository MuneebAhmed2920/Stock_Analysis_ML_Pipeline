...
st.set_page_config(
    page_title="Stock Analysis ML Pipeline",
    page_icon="📈",
    layout="wide",
...
def display_welcome_page():
    """Display the welcome page with animation, instructions, and extra content"""
    st.markdown(f"""
        <style>
        ...
        <div class="video-bg-container">
            <video autoplay loop muted playsinline>
                <source src="https://cdn.pixabay.com/video/2024/12/25/248691_large.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
        </div>
        <div class="welcome-content">
            <h1 style="color: {COLOR_SCHEME['text']}; font-size: 2.5rem; margin-bottom: 1rem;">
                📈 Stock Analysis ML Pipeline
            </h1>
            <p style="color: {COLOR_SCHEME['text_secondary']}; font-size: 1.2rem; margin-bottom: 2rem;">
                Welcome to your AI-powered stock analysis platform!
            </p>
            <h2 style='color: {COLOR_SCHEME['primary']}; margin-bottom: 0.5rem;'>What can you do here?</h2>
            <ul style='color: {COLOR_SCHEME['text_secondary']}; text-align: left; max-width: 600px; margin: 0 auto 2rem auto; font-size: 1.1rem;'>
            ...
            <h3 style='color: {COLOR_SCHEME['accent']}; margin-bottom: 0.5rem;'>How to get started?</h3>
            <ol style='color: {COLOR_SCHEME['text_secondary']}; text-align: left; max-width: 600px; margin: 0 auto 2rem auto; font-size: 1.05rem;'>
            ...
            <p style='color: {COLOR_SCHEME['text_secondary']}; margin-top: 2rem;'>
    ...
    with col1:
        st.markdown(f"""
            <div class="metric-card">
                <h3>📊 Data Analysis</h3>
                <p>Upload your own dataset or fetch real-time stock data using Yahoo Finance API</p>
            </div>
        """, unsafe_allow_html=True)
    with col2:
        st.markdown(f"""
            <div class="metric-card">
                <h3>🤖 ML Pipeline</h3>
                <p>Automated machine learning pipeline with preprocessing, feature engineering, and model selection</p>
            </div>
        """, unsafe_allow_html=True)
    with col3:
        st.markdown(f"""
            <div class="metric-card">
                <h3>📈 Predictions</h3>
                <p>Get stock price predictions with interactive visualizations and downloadable reports</p>
            </div>
        """, unsafe_allow_html=True)
...
def main():
    ...
    if 'current_step' not in st.session_state:
        ...
        if current_step == "Data Loading":
            st.write("Choose how you want to load your stock data:")
    ...
    st.markdown(f"""
        ...
        <div class="footer">
            &copy; {datetime.now().year} Stock Analysis ML Pipeline &mdash; Made with <span style='color: {COLOR_SCHEME['accent']};'>&#10084;</span> by Muneeb Ahmed | <a href="https://github.com/your-repo" style="color: {COLOR_SCHEME['primary']};" target="_blank">GitHub</a>
        </div>
    """, unsafe_allow_html=True)
